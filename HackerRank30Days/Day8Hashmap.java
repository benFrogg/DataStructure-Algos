...
Each of the n subsequent lines describes an entry in the form of 2 space-separated 
values on a single line. The first value is a friend's name, and the second value is an
...
in the phone book; otherwise, print the full name and phoneNumber in the format
name=phoneNumber.
