...
(scaled to 1 decimal place) on the second line, 
...
When we sum the floating-poinnt numbers 4.0 and 4.0, we get 8.0.
...
Case values to your variables instead of following the instructions 
