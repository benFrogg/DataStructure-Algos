...
position. In the second round, the 3 is swapped at 2 of the 3 comparisons. 
...
Explanation 1
The array a = [3, 2, 1] is not sorted, so we perform the following 3 swaps. Each line shows a 
